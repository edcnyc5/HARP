...
export let allChurches = readable(['Tabernáculo Zoe','Tabernáculo de Adoración','Third Exodus Assembly','Tabernáculo del Señor Jesucristo','Tabernáculo Voz de Aclamación','Tabernaculo El Shaddai','Tabernáculo Alas de Aguila','Tabernáculo de Cúcuta','Tabernáculo Iglesia de Dios','Tabernáculo Vida','MISC']); 
export let allSBs = readable(['Santa Biblia', 'Exposición']);
export let specialList = writable(false);
