<script>
	...
	function numSortFunc(a,b) {
		console.log('a.Name.substring(0,2): ', a.Name.substring(0,2));
		console.log('b.Name.substring(0,2): ', b.Name.substring(0,2));
...
<section id="playlist-cont w-full h-36">
	...
	<ul class:show-list={listIsShowing}>
		{#each $expAudios.sort((a,b) => Number(a.Name.substring(0,2)) - Number(b.Name.substring(0,2))) as {Name, Url, Church}, i}
